    ...
    return (
        <div className={SMain.remoteJob}>
            <div className={SMain.__container}>
                <h2 className={SMain.title}> Considering remote work</h2>
                <div className={SMain.btn}>
                    <div className={SMain.button}><a href="https://shtheme.com/demosd/nilswp/?page_id=91">Download
                        CV <i className={SMain.tiDownload}>
                            <svg enable-background="new 0 0 141.732 141.732" height="16px" id="Livello_1"
                                 fill="white"
                                 version="1.1" viewBox="0 0 141.732 141.732" width="22px"
                    ...
                    </a> <span className={SMain.btnBlock}></span>
                    </div>
                </div>
            </div>
        </div>
